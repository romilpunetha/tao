...
- For every code change to through `ai_docs\templates\task_template.md` and follow the instructions there to generate a changelog. Also update the GEMINI.md and memory so that the AI agent has the latest information on the system.
