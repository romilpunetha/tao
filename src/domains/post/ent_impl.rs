...
impl EntPost {
    ...
    pub(crate) async fn from_tao_object(tao_obj: TaoObject) -> AppResult<Option<EntPost>> {
        ...
        let entity = EntPost::read_from_in_protocol(&mut protocol)
    ...
    pub async fn get_author(&self) -> AppResult<Vec<EntUser>> {
        ...
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "author".to_string(), Some(100))
            .await?;
    ...
    pub async fn get_comments(&self) -> AppResult<Vec<EntComment>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "comments".to_string(), Some(100))
            .await?;
    ...
    pub async fn get_liked_by(&self) -> AppResult<Vec<EntUser>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "liked_by".to_string(), Some(100))
            .await?;
    ...
    pub async fn get_mentioned_users(&self) -> AppResult<Vec<EntUser>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "mentioned_users".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_mentioned_users(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "mentioned_users".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn get_appears_on_pages(&self) -> AppResult<Vec<EntPage>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "appears_on_pages".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_appears_on_pages(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "appears_on_pages".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn remove_appears_on_page(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "appears_on_pages".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_shared_in_groups(&self) -> AppResult<Vec<EntGroup>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "shared_in_groups".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_shared_in_groups(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "shared_in_groups".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn add_shared_in_group(&self, target_id: i64) -> AppResult<()> {
        ...
        let _shared_in_group =
            EntGroup::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
                crate::error::AppError::NotFound(format!(
                    "EntGroup with id {} not found",
                    target_id
                ))
            })?)
            .await?;
    ...
    pub async fn remove_shared_in_group(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "shared_in_groups".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_related_events(&self) -> AppResult<Vec<EntEvent>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "related_events".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_related_events(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "related_events".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn remove_related_event(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "related_events".to_string(), target_id)
            .await
    }
}
