...
impl EntPostBuilder {
    ...
    pub fn build(self, id: i64) -> Result<EntPost, String> {
        ...
        let entity = EntPost {
            ...
            post_type: self.post_type.ok_or_else(|| 
                "Required field 'post_type' not provided".to_string()
            )?,
            visibility: self.visibility,
            like_count: self.like_count.ok_or_else(|| 
                "Required field 'like_count' not provided".to_string()
            )?,
            comment_count: self.comment_count.ok_or_else(|| 
                "Required field 'comment_count' not provided".to_string()
            )?,
            share_count: self.share_count.ok_or_else(|| 
...
#[async_trait]
impl EntBuilder for EntPostBuilder {
    type EntityType = EntPost;
