...
pub type ENTCOMMENT_CONTENT = String;
...
impl EntComment {
  pub fn new(id: i64, author_id: i64, post_id: i64, content: String, created_time: i64) -> EntComment {
    EntComment {
      id,
      author_id,
      post_id,
...
impl TSerializable for EntComment {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<EntComment> {
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("EntComment.id", &f_1)?;
    verify_required_field_exists("EntComment.author_id", &f_2)?;
    verify_required_field_exists("EntComment.post_id", &f_3)?;
    verify_required_field_exists("EntComment.content", &f_4)?;
    verify_required_field_exists("EntComment.created_time", &f_5)?;
    let ret = EntComment {
      ...
      post_id: f_3.expect("auto-generated code should have checked for presence of required fields"),
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    o_prot.write_field_end()?;
    o_prot.write_field_begin(&TFieldIdentifier::new("post_id", TType::I64, 3))?;
