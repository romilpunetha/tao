...
impl EntComment {
    ...
    pub async fn from_tao_object(tao: &Tao, tao_obj: TaoObject) -> AppResult<Option<EntComment>> {
    ...
    pub async fn get_post(&self, tao: &Tao) -> AppResult<Vec<EntPost>> {
    ...
    pub async fn count_post(&self, tao: &Tao) -> AppResult<i64> {
