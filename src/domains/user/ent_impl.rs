...
impl EntUser {
    ...
    pub async fn get_friends(&self) -> AppResult<Vec<EntUser>> {
        ...
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "friends".to_string(), Some(100))
            .await?;
    ...
    pub async fn add_friend(&self, target_id: i64) -> AppResult<()> {
        ...
        let _friend = EntUser::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
            crate::error::AppError::NotFound(format!("EntUser with id {} not found", target_id))
        })?)
        .await?;

        let assoc = crate::infrastructure::tao_core::tao_core::create_tao_association(
            self.id(),
            "friends".to_string(),
            target_id,
            None,
    ...
    pub async fn remove_friend(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "friends".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_following(&self) -> AppResult<Vec<EntUser>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "following".to_string(), Some(100))
            .await?;
    ...
    pub async fn add_following(&self, target_id: i64) -> AppResult<()> {
        ...
        // Fetch the EntUser to ensure it exists before creating an association
        let _following =
            EntUser::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
                crate::error::AppError::NotFound(format!("EntUser with id {} not found", target_id))
            })?)
            .await?;
    ...
    pub async fn remove_following(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "following".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_followers(&self) -> AppResult<Vec<EntUser>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "followers".to_string(), Some(100))
            .await?;
    ...
    pub async fn get_liked_posts(&self) -> AppResult<Vec<EntPost>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "liked_posts".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_liked_posts(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "liked_posts".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn add_liked_post(&self, target_id: i64) -> AppResult<()> {
        ...
        let _liked_post =
            EntPost::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
                crate::error::AppError::NotFound(format!("EntPost with id {} not found", target_id))
            })?)
            .await?;
    ...
    pub async fn remove_liked_post(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "liked_posts".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_groups(&self) -> AppResult<Vec<EntGroup>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "groups".to_string(), Some(100))
            .await?;
    ...
    pub async fn add_group(&self, target_id: i64) -> AppResult<()> {
        ...
        let _group = EntGroup::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
            crate::error::AppError::NotFound(format!("EntGroup with id {} not found", target_id))
        })?)
        .await?;
    ...
    pub async fn remove_group(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "groups".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_followed_pages(&self) -> AppResult<Vec<EntPage>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "followed_pages".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_followed_pages(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "followed_pages".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn add_followed_page(&self, target_id: i64) -> AppResult<()> {
        ...
        let _followed_page =
            EntPage::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
                crate::error::AppError::NotFound(format!("EntPage with id {} not found", target_id))
            })?)
            .await?;
    ...
    pub async fn remove_followed_page(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "followed_pages".to_string(), target_id)
            .await
    }
    ...
    pub async fn get_attending_events(&self) -> AppResult<Vec<EntEvent>> {
        let tao = get_global_tao()?.clone();
        let neighbor_ids = tao
            .get_neighbor_ids(self.id(), "attending_events".to_string(), Some(100))
            .await?;
    ...
    pub async fn count_attending_events(&self) -> AppResult<i64> {
        let tao = get_global_tao()?.clone();
        let count = tao
            .assoc_count(self.id(), "attending_events".to_string())
            .await?;
        Ok(count as i64)
    }
    ...
    pub async fn add_attending_event(&self, target_id: i64) -> AppResult<()> {
        ...
        let _attending_event =
            EntEvent::from_tao_object(tao.obj_get(target_id).await?.ok_or_else(|| {
                crate::error::AppError::NotFound(format!(
                    "EntEvent with id {} not found",
                    target_id
                ))
            })?)
            .await?;
    ...
    pub async fn remove_attending_event(&self, target_id: i64) -> AppResult<bool> {
        let tao = get_global_tao()?.clone();
        tao.assoc_delete(self.id(), "attending_events".to_string(), target_id)
            .await
    }
}
