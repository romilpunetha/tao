...
impl EntBuilder for EntUser {
    ...
    fn build(state: Self::BuilderState, id: i64) -> Result<Self, String> {
        ...
        Ok(EntUser {
            ...
            username: state
                .username
                .ok_or_else(|| "Required field 'username' not provided".to_string())?,
            email: state
                .email
                .ok_or_else(|| "Required field 'email' not provided".to_string())?,
            ...
            is_verified: state
                .is_verified
                .ok_or_else(|| "Required field 'is_verified' not provided".to_string())?,
...
impl EntUser {
    ...
    pub fn create() -> EntUserBuilderState {
        EntUserBuilderState::default()
    }
}
