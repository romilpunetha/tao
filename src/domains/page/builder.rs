...
impl EntPageBuilder {
    ...
    pub async fn save(self, tao: &Tao) -> AppResult<EntPage> {
        ...
        let generated_id = tao.obj_add("ent_page".to_string(), data, None).await?;

        // Create final entity with generated ID
        let mut final_entity = entity;
        final_entity.id = generated_id;

        println!("✅ Created EntPage with TAO ID: {}", generated_id);
