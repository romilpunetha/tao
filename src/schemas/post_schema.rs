...
impl EntSchema for PostSchema {
    ...
    fn fields() -> Vec<FieldDefinition> {
        vec![
            ...
            // Optional media
            FieldDefinition::new("media_url", FieldType::String)
                .optional(),
            ...
            FieldDefinition::new("updated_time", FieldType::Time)
                .optional(),
            ...
            // Engagement metrics
            FieldDefinition::new("like_count", FieldType::Int)
                .default_value(FieldDefault::Int(0)),
                
            FieldDefinition::new("comment_count", FieldType::Int)
                .default_value(FieldDefault::Int(0)),
                
            FieldDefinition::new("share_count", FieldType::Int)
                .default_value(FieldDefault::Int(0)),
                
            // SEO and discovery
            FieldDefinition::new("tags", FieldType::JSON)
                .optional(),
                
            FieldDefinition::new("mentions", FieldType::JSON)
                .optional(),
        ]
    }
    ...
    fn edges() -> Vec<EdgeDefinition> {
        vec![
            ...
            EdgeDefinition::from("author", EntityType::EntUser, "posts")
                .required(),
